...
<div class="cabeça"> 
 <img src="logo IILP.png" alt="" width="300" id="img">
    ...
    <h1 id="tema">Dicionário de Língua Portuguesa</h1>
...
<div id="menu">
    <a href="proverbio">Provérbios</a>
    <a href="#">Expressões idiomáticas</a>
    <a href="http://localhost/novo%20pag/topo.html">Topónimos</a>
    <a href="#">Antropónimos</a>
    <a href="#">Siglas</a>
    <a href="#">Abreviaturas</a>
    <a href="#">Acrónimos</a>
    <a href="#">Anedotas</a>
    <a href="#">Adivinhas</a>
</div>
...
<div id="album">
  ...
  if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
          ...
          echo "<div class='page'>";
          echo '<h2 id="r">' . $row['termo'] . '</h2> ';
          echo '<p id="divisao">['. $row['divisao'].']  ' . $row['classe_gramatical'] . ' (' . $row['de'] .')</p><br>';
            
          echo '<p id="r">Definição 1 ' . $row['definicao1'] . '</p>';
          echo '<br><div class="vertical-bar5"></div>';
          echo '<strong><p id="contexto1">Contexto</p></strong> <br>';


          echo '<p id="r">Definição 2 ' . $row['definicao2'] . '</p>';
          echo '<br><div class="vertical-bar5"></div>';
          echo '<strong><p id="contexto1">Contexto</p></strong> <br>';

          echo '<p " id="r">Definição 3 ' . $row['definicao3'] . '</p><br>';
          echo '<br><div class="vertical-bar5"></div>';
          echo ' <strong><p id="contexto1">Contexto</p></strong><br>';
